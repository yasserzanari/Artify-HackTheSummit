...
export default function ArtworkDetailPage({
  ...
  // Hydrate auth
  useAuth();
  useLike(id); // keep like state warm
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-background md:max-w-120 md:mx-auto md:shadow-2xl">
      {/* ── Hero image (55 vh) ── */}
      <div className="relative shrink-0" style={{ height: "55dvh" }}>
        ...
        {/* Subtle gradient at top (for icon legibility) */}
        <div
      ...
      {/* ── Content below image ── */}
      <div className="flex-1 px-5 pt-5 pb-32 relative">
        {/* Category + year */}
        <p
      ...
      <button
        className="fixed bottom-24 right-5 w-10 h-10 rounded-full bg-surface border border-border shadow-md flex items-center justify-center text-muted text-sm font-medium z-10"
